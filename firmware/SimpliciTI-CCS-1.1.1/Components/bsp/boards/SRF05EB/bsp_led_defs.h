...
#define __bsp_LED_BLINK_LOOP_COUNT__   0x4000
...
#define __bsp_LED1_PORT__           P4OUT
#define __bsp_LED1_DDR__            P4DIR
...
#define __bsp_LED2_PORT__           P4OUT
#define __bsp_LED2_DDR__            P4DIR
...
#define __bsp_LED4_PORT__           P4OUT
#define __bsp_LED4_DDR__            P4DIR
